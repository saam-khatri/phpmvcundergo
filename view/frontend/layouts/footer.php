            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-about mt-40">
                        <div class="logo">
                            <a href="#"><img src="<?= url('public/frontend/images/logo-2.png" alt="Logo'); ?>"></a>
                        </div>
...
<!--====== jquery js ======-->
<script src=" <?= url('public/frontend/js/vendor/modernizr-3.6.0.min.js'); ?>"></script>
...
<!--====== Nice Number js ======-->
<script src=" <?= url('public/frontend/js/jquery.nice-number.min.js'); ?>"></script>
...
<!--====== Ajax Contact js ======-->
<script src=" <?= url('public/frontend/js/ajax-contact.js'); ?>"></script>
...
<script src=" <?= url('public/frontend/js/map-script.js'); ?>"></script>
